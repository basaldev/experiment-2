...
Apikey.apiKey = keys.cloudmersive;

var apiInstance = new CloudmersiveOcrApiClient.ImageOcrApi();

var imageFile = Buffer.from(fs.readFileSync("example/example3.png").buffer); // File | Image file to perform OCR on.  Common file formats such as PNG, JPEG are supported.
